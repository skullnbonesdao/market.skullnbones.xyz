<template>
  <div class="p-card p-3">
    ...
    <p>Last updated: September 18, 2022</p>
    ...
    <ul>
      <li>
        ...
        refers to Skull&amp;BonesDAO, StarAtlas.
      </li>
      ...
      <li>
        <strong>Website</strong> refers to RougeMarket, accessible from
        <a href="market.skullnbones.xyz">market.skullnbones.xyz</a>
      </li>
    </ul>
    <h1 id="disclaimer">Disclaimer</h1>
    <p>
    ...
    <p>
      ...
      <a href="https://www.freeprivacypolicy.com/free-disclaimer-generator/"
    ...
    <h1 id="external-links-disclaimer">External Links Disclaimer</h1>
    <p>
    ...
    <h1 id="errors-and-omissions-disclaimer">
    ...
    <h1 id="fair-use-disclaimer">Fair Use Disclaimer</h1>
    <p>
    ...
    <h1 id="views-expressed-disclaimer">Views Expressed Disclaimer</h1>
    <p>
    ...
    <h1 id="no-responsibility-disclaimer">No Responsibility Disclaimer</h1>
    <p>
    ...
    <h1 id="-use-at-your-own-risk-disclaimer">
    ...
    <ul>
      <li>
        ...
        <a href="skullnbones.xyz">skullnbones.xyz</a>
      </li>
    </ul>
  </div>
</template>
